                    ...
                    <div className="col-md-9">
                        ...
                        <form onSubmit={postData}>
                            <div className="row">
                                ...
                                <div className="col-12 mb-3">
                                    <label>Answer*</label>
                                    <textarea name="answer" value={data.answer} rows={3} onChange={getInputData} placeholder='Faq Answer' className={`form-control ${show && errorMessage.answer ? 'border-danger' : 'border-dark'}`} />
