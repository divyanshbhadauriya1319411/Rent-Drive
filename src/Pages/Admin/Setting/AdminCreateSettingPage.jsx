...
export default function AdminCreateSettingPage() {
    ...
    function postData(e) {
        ...
        if (error)
            ...
            let item = SettingStateData.find(x => x.question?.toLocaleLowerCase() === data.question?.toLocaleLowerCase())
            if (item) {
                setShow(true)
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary text-light text-center p-2'>Create Setting
                        ...
                        <form onSubmit={postData}>
                            <div className="row">
                                <div className="col-12 mb-3">
                                    ...
                                    <input type="text" name="question" onChange={getInputData} placeholder='Question' className={`form-control ${show && errorMessage.question ? 'border-danger' : 'border-dark'}`} />
                                    {show && errorMessage.question ? <p className='text-danger text-capitalize'>{errorMessage.question}</p> : null}
                                </div>

                                <div className="col-12 mb-3">
                                    <label>Answer*</label>
                                    <textarea name="answer" rows={3} onChange={getInputData} placeholder='Setting Answer' className={`form-control ${show && errorMessage.answer ? 'border-danger' : 'border-dark'}`} />
